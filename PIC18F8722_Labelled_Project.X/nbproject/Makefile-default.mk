...
FINAL_IMAGE=${DISTDIR}/PIC18F8722_Labelled_Project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=labelled_example.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/labelled_example.o
POSSIBLE_DEPFILES=${OBJECTDIR}/labelled_example.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/labelled_example.o

# Source Files
SOURCEFILES=labelled_example.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PIC18F8722_Labelled_Project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F8722
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/PIC18F8722_Labelled_Project.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/labelled_example.o: labelled_example.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/labelled_example.o 
	${MP_AS} -mcpu=PIC18F8722 -c \
	-o ${OBJECTDIR}/labelled_example.o \
	labelled_example.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PIC18F8722_Labelled_Project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F8722 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/PIC18F8722_Labelled_Project.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
